...
// DIVERGENCE PROBE. Frame size depends on the ante only, ignoring Overstock,
// so every seed does exactly 17,910 shop cards and the card/rarity/edition
// loops have identical trip counts in every lane of a warp.
// ===========================================================================
...
long filter(instance* inst) {
    ...
    for (int ante = 1; ante <= DNS_LAST_ANTE; ante++) {
        ...
        int frameSize = 2; // DIVERGENCE PROBE: ignore Overstock
