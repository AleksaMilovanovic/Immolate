...
// deep_negative_shops with CACHE_SIZE forced to 32.
//
...
// so 32 slots overflow on a fraction of seeds and init_node then silently
...
#define DNS_CACHE_SIZE_OVERRIDE 32
