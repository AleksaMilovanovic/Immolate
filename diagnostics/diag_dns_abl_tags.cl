...
// Ablates the two per-ante TAG draws. Side-effect free. The voucher stream
// is NOT ablated because dropping it would change frame sizes and hence
// the amount of downstream work; it is only 38 draws/seed (~0.07%).
// ===========================================================================
