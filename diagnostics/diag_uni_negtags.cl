// Divergence probe, not a filter: runs negative_tags on a seed whose rank is
...
long filter(instance* inst, long cutoff) { diag_uni_reseed(inst); return diag_real_filter(inst, 0) - 1000000; }
